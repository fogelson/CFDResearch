		...
		for(int j = g->jMin; j <= g->jMax; j++){
			if(g->cells(i,j)->isUncovered()){
				...
				if(faces(N) != 0){
					...
					else if(false && faces(N)->isIrregular()){
						if(coefficients.count(cellIndex) == 0 || coefficients[cellIndex].count(faceIndex) == 0){
				...
				if(faces(S) != 0){
					...
					else if(false && faces(S)->isIrregular()){
						if(coefficients.count(cellIndex) == 0 || coefficients[cellIndex].count(faceIndex) == 0){
				...
				if(faces(E) != 0){
					...
					else if(false && faces(E)->isIrregular()){
						if(coefficients.count(cellIndex) == 0 || coefficients[cellIndex].count(faceIndex) == 0){
				...
				if(faces(W) != 0){
					...
					else if(false && faces(W)->isIrregular()){
						if(coefficients.count(cellIndex) == 0 || coefficients[cellIndex].count(faceIndex) == 0){
