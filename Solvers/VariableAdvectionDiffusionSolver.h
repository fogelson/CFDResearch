...
namespace CFD{
	namespace Solvers{
		...
		double applyCoefficients(Coefficients coefficients, CellDoubleArray &u, int i, int j, Grid * g){
		...
		public:
			static Coefficients getCoefficients(CellDoubleArray &u, int i, int j, Grid * g, AdvectionData &A){
				double h = g->h;
		...
		public:
			static Coefficients getCoefficients(bool xDir, CellDoubleArray &u, int i, int j, Grid * g, AdvectionData &A){
				double h = g->h;
		...
		public:
			static Coefficients implicitCoefficients(bool xDir, CellDoubleArray &u, int i, int j, Grid * g, AdvectionData &A){
				Coefficients coefficients;
				/*// FE advection
			...
			static Coefficients explicitCoefficients(bool xDir, CellDoubleArray &u, int i, int j, Grid * g, AdvectionData &A){
				Coefficients coefficients;
				/*// FE advection
				coefficients = (DiffusionStencil::getCoefficients(u,i,j,g))/4 - (AdvectionStencil::getCoefficients(xDir,u,i,j,g));*/
